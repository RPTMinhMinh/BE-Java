...
/*
Bài tập 1: Áp dụng tính kế thừa Đề bài: Xây dựng chương trình quản lý động vật trong sở thú: 1. Tạo lớp cha Animal với các thuộc tính và phương thức:    • Thuộc tính:        name (tên động vật),        age (tuổi). • Phương thức:    method:        eat() (in ra “Animal is eating”).2. Tạo các lớp con:    • Lion: có phương thức riêng roar() (in ra “Lion is roaring”).    • Elephant: có phương thức riêng trumpet() (in ra “Elephant is trumpeting”). 3. Tạo đối tượng Lion và Elephant, gọi các phương thức chung (eat()) và phương thức riêng (roar(), trumpet()) của chúng.
